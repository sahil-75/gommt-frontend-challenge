        ...
        return (
            <SafeAreaView style={[styles.container, { alignItems: 'center' }]}>
                ...
                <View style={{ alignItems: 'center', padding: 20 }}>
                    <TextInput onChangeText={(text) => this.setState({ username: text })} placeholder='Username / Email Id' placeholderTextColor={ColorTheme.whiteFaded} style={[styles.box, styles.textInput, { width: 250 }]} />
                    <TextInput onChangeText={(text) => this.setState({ password: text })} placeholder='Password' secureTextEntry={true} placeholderTextColor={ColorTheme.whiteFaded} style={[styles.box, styles.textInput, { width: 250 }]} />
